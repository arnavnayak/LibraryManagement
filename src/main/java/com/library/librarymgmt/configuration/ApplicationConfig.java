package com.library.librarymgmt.configuration;
...
@Configuration
@EnableMongoRepositories(basePackages="com.library.librarymgmt.repository")
public class ApplicationConfig extends AbstractMongoClientConfiguration {
    ...
    protected Collection<String> getMappingBasePackages() {
        return Collections.singleton("com.library.librarymgmt");
    }
}
